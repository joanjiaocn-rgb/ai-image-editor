...
export const metadata = { title: "Shopify Product Image Generator | Luma Edit", description: "Create consistent Shopify product images from one upload with backgrounds, framing, and storefront-ready variations.", alternates: { canonical: "/shopify-product-image-generator" } };
