...
export const metadata = { title: "Create Lifestyle Product Photos with AI | Luma Edit", description: "Create believable lifestyle product photos from one source image for Etsy, Shopify, and social commerce.", alternates: { canonical: "/create-lifestyle-product-photos" } };
