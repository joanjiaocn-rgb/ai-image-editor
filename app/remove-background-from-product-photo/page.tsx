...
export const metadata = { title: "Remove Background from Product Photo | Luma Edit", description: "Remove distracting backgrounds from product photos and create clean listing-ready images for your online store." };
